...
#include "altitude_ctrl_ui_1_gen.h"
...
static uint32_t altitude_ctrl_ui_1_target = ALTITUDE_CTRL_UI_1_TARGET_ALL;
...
{
    altitude_ctrl_ui_1_target = target;
}

uint32_t altitude_ctrl_ui_1_get_target(void)
{
    return altitude_ctrl_ui_1_target;
}

bool altitude_ctrl_ui_1_check_target(uint32_t target)
{
    return (altitude_ctrl_ui_1_target & target) ? true : false;
}
