/**
 * @file altitude_ctrl_ui_1_gen.h
 */

#ifndef ALTITUDE_CTRL_UI_1_GEN_H
#define ALTITUDE_CTRL_UI_1_GEN_H
...
void altitude_ctrl_ui_1_set_target(uint32_t target);
uint32_t altitude_ctrl_ui_1_get_target(void);
bool altitude_ctrl_ui_1_check_target(uint32_t target);

/*********************
 *      DEFINES
 *********************/

#define ALTITUDE_CTRL_UI_1_TARGET_UNDEFINED  (0 << 1)
#define ALTITUDE_CTRL_UI_1_TARGET_TARGET1    (1 << 1)
#define ALTITUDE_CTRL_UI_1_TARGET_ALL        0x0FFFFFFF

/* By default compile for all targets, allowing to switch to any targets at runtime */
#ifndef ALTITUDE_CTRL_UI_1_COMPILE_TARGET
#define ALTITUDE_CTRL_UI_1_COMPILE_TARGET ALTITUDE_CTRL_UI_1_TARGET_ALL
#endif

#define ALTITUDE_CTRL_UI_1_CHECK_COMPILE_TARGET(target) (ALTITUDE_CTRL_UI_1_COMPILE_TARGET & (target) ? 1 : 0)
...
void altitude_ctrl_ui_1_init_gen(const char * asset_path);
...
#endif /*ALTITUDE_CTRL_UI_1_GEN_H*/